...
function twx_custom_styles( $customizer_style ) {
	...
	//Background color
	$primary_color = get_theme_mod( 'primary_color', '#4DA2FF' );
	...
	//Theme text color
	$theme_text_color = get_theme_mod( 'theme_text_color', '#444444' );
