...
<html <?php language_attributes(); ?>>
  ...
  <?php do_action('consultent_before_site'); ?>
  	<?php 
	if ( function_exists( 'consultent_contact_info' ) ) {
		consultent_contact_info(); 
	}?>
	...
	<?php 
	if ( function_exists( 'consultent_mobile_header' ) ) {
		//consultent_mobile_header(); 
	}?>
		...
		<?php if( is_front_page() ) : ?>
			<?php
				...
				if ( $banner_type == 'video' && is_front_page() ) :
					consultent_banner_video();
				elseif ( $banner_type == 'carousel' && is_front_page() ) :
					consultent_banner_slider();
				else :
					consultent_banner_background();
				endif;
			?>
		<?php else : ?>
			<div class="other-header">
				<div class="header-content other">
					...
					<div class = "breadcrumb" ><?php if (class_exists('WooCommerce')){
							( (is_woocommerce())? woocommerce_breadcrumb() :consultent_get_breadcrumb() );
						}else{
							consultent_get_breadcrumb();
						}?></div>
					<?php endif; ?>
				</div>
			</div>
