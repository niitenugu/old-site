    ...
    <div class="content-box">
      ...
      <div class="element-wrapper">
        ...
        <div class="element-box">
          ...
          <form action="{{ route('admin.jobs.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
            @csrf
          ...
          <div class="form-group">
            ...
            <input class="form-control @error('title') is-invalid @enderror" name="title" placeholder="Enter event title" type="text" value="{{ old('title') }}" id="event-title" required>
            @error('title')
          ...
          <div class="form-group">
            ...
            <input class="custom-daterange form-control" name="opening_date" placeholder="Job Opening and Closing Date" type="text" value="{{ old('opening_date') }}" id="opening-date">
          </div>

          <div class="form-check">
            <label class="form-check-label">
              <input class="form-check-input" name="is_live" {{ old('is_live') ? 'checked' : '' }} type="checkbox"> Make this job visible on the website
            </label>
          </div>
