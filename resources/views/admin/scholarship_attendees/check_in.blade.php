      ...
      <div class="element-wrapper">
        ...
        <div class="element-box">
          ...
          <div class="form-desc" style="color:#333;">
            Check-in attendees for this scholarship. Search for an attendee on the invite list using any of the 
          ...
          <form class="form-inline" {{ route('admin.scholarship_attendees.checkin', $scholarship->uid) }} method="GET">
            ...
            @empty
              <div class="post-box alert alert-primary">
                <div class="post-content text-center">
                  ...
                  <a href="{{ route('admin.scholarship_attendees.create', $scholarship->uid) }}"><u>You can register attendee instead</u></a>
                </div>
              </div>
            @endforelse
