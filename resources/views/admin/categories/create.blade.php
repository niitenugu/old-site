...
@section('page_title', '| Create Course Category')
      ...
      <div class="element-wrapper">
        ...
        <div class="element-box">
          ...
          <div class="form-group">
            ...
            <input class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Enter category name" type="text" value="{{ old('name') }}" id="category-name" required>
            @error('name')
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="description" rows="5" id="description" placeholder="Brief description of the category">{{ old('description') }}</textarea>
          </div>
