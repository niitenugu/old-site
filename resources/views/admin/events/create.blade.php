    ...
    <div class="content-box">
      ...
      <div class="element-wrapper">
        ...
        <div class="element-box">
          ...
          <form action="{{ route('admin.events.store') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
            @csrf
          ...
          <div class="form-group">
            ...
            <input class="form-control @error('title') is-invalid @enderror" name="title" placeholder="Enter event title" type="text" value="{{ old('title') }}" id="event-title">
            @error('title')
          ...
          <div class="form-group">
            ...
            <input class="form-control @error('venue') is-invalid @enderror" name="venue" placeholder="Enter venue of the event" type="text" value="{{ old('venue') }}" id="event-venue">
            @error('venue')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
